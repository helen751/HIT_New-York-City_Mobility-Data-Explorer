...
```sql
CREATE USER 'HIT_team'@'localhost' IDENTIFIED BY 'StrongPass123!';
GRANT ALL PRIVILEGES ON hit_urban_mobility_db.* TO 'HIT_team'@'localhost';
FLUSH PRIVILEGES;
...
Ensure credentials inside `backend/db.py` and your database match your setup:
